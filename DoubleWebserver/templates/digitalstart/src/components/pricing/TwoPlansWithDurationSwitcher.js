...
export default ({
  ...
  const defaultPlans = [
    {
      name: "Monthly",
      durationPrices: ["KES 1,500", "$499"],
      mainFeature: "Suited for those who need help with management.",
      features: ["60 Templates", "8 Landing Pages", "22 Internal Pages", "Priority Assistance", "Lifetime Updates"],
      featured: true
    },
    {
      name: "One Time",
      durationPrices: ["KES 5,000", "$499"],
      mainFeature: "Suited for those with a developer in their organization.",
      features: ["60 Templates", "8 Landing Pages", "22 Internal Pages", "Priority Assistance", "Lifetime Updates"],
      featured: true
    }
  ];

...
import { Pricing2 as Pricing } from "components/pricing/ThreePlans.js";
...
const RightColumn = styled.div`
  ...
  ${tw`bg-green-500 bg-cover bg-center xl:ml-24 h-96 lg:h-auto lg:mt-24 lg:w-1/2 lg:flex-1`}
`;

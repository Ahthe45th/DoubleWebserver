...
def serve_static_react_files(type, file):
    return send_file(f"{template_folder}/templates/UKD/socialmedia/build/static/{type}/{file}")

@webparts_blueprint.route('/signup', methods=['GET', 'POST'])
def signup():
    return send_file(f"{template_folder}/templates/UKD/socialmedia/build/index.html")
